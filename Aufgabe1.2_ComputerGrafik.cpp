...
// Aufgabe1.2_ComputerGrafik.cpp: Definiert das Klassenverhalten für die Anwendung.
//
...
BEGIN_MESSAGE_MAP(CAufgabe12ComputerGrafikApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAufgabe12ComputerGrafikApp::OnAppAbout)
END_MESSAGE_MAP()


// CAufgabe12ComputerGrafikApp-Erstellung

CAufgabe12ComputerGrafikApp::CAufgabe12ComputerGrafikApp() noexcept
{
	...
	SetAppID(_T("Aufgabe12ComputerGrafik.AppID.NoVersion"));

	// TODO: Hier Code zur Konstruktion einfügen
	// Alle wichtigen Initialisierungen in InitInstance positionieren
}

// Das einzige CAufgabe12ComputerGrafikApp-Objekt

CAufgabe12ComputerGrafikApp theApp;


// CAufgabe12ComputerGrafikApp-Initialisierung

BOOL CAufgabe12ComputerGrafikApp::InitInstance()
{
...
int CAufgabe12ComputerGrafikApp::ExitInstance()
{
...
// CAufgabe12ComputerGrafikApp-Meldungshandler
...
void CAufgabe12ComputerGrafikApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
